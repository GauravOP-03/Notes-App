        ...
        <footer className="bg-white/70 border-t py-4 sm:py-8 px-4 text-sm text-gray-600">
            <div className="max-w-7xl mx-auto flex flex-col sm:grid sm:grid-cols-4 gap-4 sm:gap-8">
                ...
                <div className="flex justify-center sm:justify-start items-center space-x-4">
                    <a href="https://github.com/GauravOP-03" target="_blank" rel="noopener noreferrer" className="hover:text-gray-900">
                        <Github className="w-5 h-5" />
                    </a>
                    <a href="https://x.com/GauravOP_03" target="_blank" rel="noopener noreferrer" className="hover:text-gray-900">
                        <Twitter className="w-5 h-5" />
                    </a>
                    <a href="https://linkedin.com/in/gaurav-kumar-5813bb321" target="_blank" rel="noopener noreferrer" className="hover:text-gray-900">
